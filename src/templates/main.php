...
<?php if (!$multiline): ?>
        <animate id='d<?php echo $i ?>' attributeName='d' begin='<?php echo ($i == 0 ? "0s;" : "") . $previousId ?>.end' dur='<?php echo 50 / $speed ?>s'
...
<?php else: ?>
    ...
    <animate id='d<?php echo $i ?>' attributeName='d' dur='<?php echo (50 / $speed) * ($i + 1) ?>s' fill="freeze"
